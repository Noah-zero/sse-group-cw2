...
from conftest import DummySupabaseClient  # Import DummySupabaseClient from conftest
...
def patch_deepseek_dependencies(monkeypatch):
    # Replace jwt.decode in deepseek module with fake_jwt_decode
    monkeypatch.setattr("deepseek.jwt.decode", fake_jwt_decode)
    # Replace deepseek.supabase_client with DummySupabaseClient instance
