...
# Define Dummy Supabase classes for testing
...
# Override the supabase.create_client function in the Supabase module
import supabase._sync.client as supabase_client_module

supabase_client_module.create_client = dummy_create_client

# Import deepseek so it uses the dummy environment variables and client
import deepseek
